...
const SubmitReport: React.FC<SubmitReport> = () => {
  ...
  const onSubmit = async (data: FormValues, event: any) => {
    ...
    try {
      const response = await fetch(
        `${REACT_APP_API_ENDPOINT}/reports/send`,
        requestOptions
      );
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(
        `${REACT_APP_API_ENDPOINT}/reports/vulnerability-types`
      );
  ...
  return (
    <section className={cls["submit-report"]}>
      <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
        <div className={cls["div-select-vulnerability_item"]}>
          <div className={"vulnerability-type"}>
            <h3>Vulnerability Type</h3>
            <p>
              Select the type of discovered potential problem. Can’t choose only
              one? Choose the most appropriate one or submit a separate report
              for each apparent deficiency.
            </p>
          </div>
        ...
        <div className={cls["div-proof-item"]}>
          <div className="proof">
            ...
            <p>
              Provide a proof of vulnerability. It can be a screenshot, a video,
              a link to a page with a
            </p>
          </div>
          ...
          <div className="select-proof_item">
            <div className="title">
              ...
              <p>
                A clear and concise name includes the type of vulnerability and
                the affected object
              </p>
            </div>
            ...
            <div className="description">
              <h3>Description*</h3>
              <p>
                Describe the vulnerability. What are the clear steps to
                reproduce it? Please replace all [square] sections below with
                appropriate details. Remember that the more details you provide,
                the easier it is for us to sort and respond quickly, so take
                your time filling out the report!
              </p>
            </div>
  ...
  * [attachment / reference]"
        ...
        <div className={cls["div-files-upload-item"]}>
          <div className="files-upload">
            <h3>Files upload</h3>
            <p>
              Proof of concept is the essential part of your report. Clear,
              reproducible steps will help us verify this problem as quickly as
              possible.
            </p>
            <Dragger {...props}>
        ...
        <div className={cls["div-submit-report-button"]}>
          <p>
            By submitting this report, you agree to the Terms of Service and
            Privacy Policy.
          </p>
